            ...
            if (tempFile.is_open()) {
                ...
                while (getline(winnerFile, line)) {
                    ...
                    if (lineNumber == 4) { // Update the fourth line
                        ...
                        iss >> currentPoints;
                        currentPoints += 125; // Increment the points by 62
                        tempFile << currentPoints << std::endl; // Write updated points to temp file
                    } else if (lineNumber == 6) { // Update the fifth line
                        std::istringstream iss(line);
...
void runTournament500() {
    ...
    enterTournamentResults500(firstRoundMatches);
    ...
    enterTournamentResults500(secondRoundMatches);
    ...
    enterTournamentResults500(semifinalMatches);
    ...
    enterTournamentResults500(finalMatch);

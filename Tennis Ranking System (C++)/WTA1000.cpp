            ...
            if (tempFile.is_open()) {
                ...
                while (getline(winnerFile, line)) {
                    ...
                    if (lineNumber == 4) { // Update the fourth line
                        ...
                        iss >> currentPoints;
                        currentPoints += 250; // Increment the points by 62
                        tempFile << currentPoints << std::endl; // Write updated points to temp file
                    } else if (lineNumber == 7) { // Update the fifth line
                        std::istringstream iss(line);
...
void runTournament1000() {
    ...
    enterTournamentResults1000(firstRoundMatches);
    ...
    enterTournamentResults1000(secondRoundMatches);
    ...
    enterTournamentResults1000(semifinalMatches);
    ...
    enterTournamentResults1000(finalMatch);
